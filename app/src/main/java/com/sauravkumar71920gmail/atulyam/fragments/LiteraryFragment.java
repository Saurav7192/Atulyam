 ...
 * Use the {@link LiteraryFragment#newInstance} factory method to
...
public class LiteraryFragment extends Fragment {
     ...
     * @return A new instance of fragment LiteraryFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LiteraryFragment newInstance(String param1, String param2) {
        LiteraryFragment fragment = new LiteraryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_literary, container, false);
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      final TopicsAdapter topicsAdapter = new TopicsAdapter(getContext(), mArrayList);
        ...
        mFirebaseDatabase.getReference("Events").child("Literary Events").addChildEventListener(new ChildEventListener() {
            @Override
