...
public class MegaFragment extends Fragment {
    ...
    private  String TAG = MegaFragment.class.getSimpleName();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
       ...
       mFirebaseDatabase.getReference("Events").child("Mega Events").addChildEventListener(new ChildEventListener() {
            @Override
